...
import TeamAdvancedInputForm from './team_advanced_input_form';
import ReactTable from 'react-table';
import {CSVLink} from 'react-csv';
import '../../../node_modules/react-table/react-table.css';
import { columns } from './team_advanced_table_columns';
...
class TeamTable extends Component {
  ...
  componentDidMount() {
    fetch('https://stats.theseventhman.net/stats/api/v1/teams/advanced/?&season=2020&team=&', { method: 'get', mode: 'cors' })
    .then(res => res.json())
    .then((data) => {
      this.setState({ data: data })
    })
